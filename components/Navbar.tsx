  ...
  return (
    <div className='flex h-24 pt-8 px-12 items-center text-white flex-row justify-between'>
      ...
      <div className='md:flex hidden items-center flex-row justify-between'>
        ...
        <Link href='/' className='transform transition duration-500 hover:scale-125 h-10 flex border-transparent rounded-lg items-center w-24 bg-gradient-to-r from-[#016BF0] to-[#00E8FF] justify-center'>Register</Link>
      ...
      <div className='md:hidden relative'>
        ...
        <Link href='/#prizes' className='mr-8 relative group'>
          ...
          <Link href='/' className='h-10  transform transition duration-500 hover:scale-125 my-2 flex font-semibold border-transparent rounded-lg items-center w-20 bg-gradient-to-r from-[#016BF0] to-[#00E8FF]  justify-center'>Register</Link>
        </div>
