  ...
  return (
    <div className='flex h-24 pt-8 px-12 items-center text-white flex-row justify-between'>
      <div className='relative'>
        <Link href='/' className='transform transition duration-500 hover:scale-125 text-2xl font-bold'>WEB3DOT</Link>
      </div>
      ...
      <div className='md:flex hidden items-center flex-row justify-between'>
        ...
        <Link href='/' className='transform transition duration-500 hover:scale-125 h-10 flex border-transparent rounded-lg items-center w-24 bg-gradient-to-r from-[#F678F0] to-[#00E8FF] justify-center'>Register</Link>
      ...
      <div className='md:hidden relative'>
        ...
        <div className={` ${open? 'block' : 'hidden'} z-50 absolute bg-[#242424] px-4 py-2 right-1 items-center text-center justify-center flex flex-col`}>
        <Link href='/' className='mr-8 relative group'>
          <span>Home</span>
          <span className="absolute -bottom-1 left-1/2 w-0 h-[2px] bg-[#EB7EF1] group-hover:w-1/2 group-hover:transition-all"></span>
          <span className="absolute -bottom-1 right-1/2 w-0 h-[2px] bg-[#EB7EF1] group-hover:w-1/2 group-hover:transition-all"></span>
        ...
        <Link href='/#prizes' className='mr-8 relative group'>
          ...
          <Link href='/' className='h-10  transform transition duration-500 hover:scale-125 my-2 flex font-semibold border-transparent rounded-lg items-center w-20 bg-gradient-to-r from-[#C385F1] to-[#7A91D6] justify-center'>Register</Link>
        </div>
